...
logo_path = "https://www.yeeply.com/wp-content/uploads/2024/04/erp-planificacion-recursos-empresariales-produccion-industrial-productividad-mejora-empresa_100456-8252.jpeg"  # Asegúrate de poner la ruta correcta
...
st.sidebar.title("Ventas Creative")

# Variables de autenticación
USER = "jcatalina120"
PASSWORD = "johanna-412*"
